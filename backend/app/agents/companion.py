        ...
        *,
        ...
        if relationship_cue_context:
            rendered_prompt += (
                ...
                "先接住用户当下的话；只有确实有助于继续时才给低压力邀请，最多一个问题，也可以不提问。"
                "不得声称自己有年龄、年代身份或亲身经历，不得使用“我们那会儿”“我们那代人”等口吻。"
                "如果后续关系角色口吻要求逐角色输出，请优先按逐角色格式输出，不要合并成一段。\n"
                "--- 关系编排计划结束 ---"
            )
